...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        if self.current_state_value == "off":
            redLight.off()
            blueLight.off()

        elif self.current_state_value == "heat":
    ...
    def setupSerialOutput(self):
        ...
        output = f"{self.current_state_value},{currentTemp},{self.setPoint}\n"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state_value.upper()}:{self.setPoint}F".ljust(16)
                altCounter = altCounter + 1
                if(altCounter >= 11):
